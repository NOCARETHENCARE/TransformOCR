...
namespace TrOCR
{
	...
	public sealed partial class FmSetting
    {
		...
		public void readIniFile()
		{
			...
			if (value10 == "发生错误")
			{
				txtBox_记录界面.Text = "Please press the shortcut key";
			}
			var value11 = IniHelp.GetValue("快捷键", "识别界面");
			txtBox_识别界面.Text = value11;
			if (value11 == "发生错误")
			{
				txtBox_识别界面.Text = "Please press the shortcut key";
			}
			pictureBox_文字识别.Image = txtBox_文字识别.Text == "Please press the shortcut key" ? Resources.快捷键_0 : Resources.快捷键_1;
			pictureBox_翻译文本.Image = txtBox_翻译文本.Text == "Please press the shortcut key" ? Resources.快捷键_0 : Resources.快捷键_1;
			pictureBox_记录界面.Image = txtBox_记录界面.Text == "Please press the shortcut key" ? Resources.快捷键_0 : Resources.快捷键_1;
			pictureBox_识别界面.Image = txtBox_识别界面.Text == "Please press the shortcut key" ? Resources.快捷键_0 : Resources.快捷键_1;
			var value12 = IniHelp.GetValue("Key_Baidu", "secret_id");
			text_baiduaccount.Text = value12;
			if (value12 == "发生错误")
			{
				text_baiduaccount.Text = "YsZKG1wha34PlDOPYaIrIIKO";
			}
			var value13 = IniHelp.GetValue("Key_Baidu", "secret_key");
			...
			if (value14 == "发生错误")
			{
				combox_代理.Text = "system proxy";
			}
			if (combox_代理.Text == "no proxy" || combox_代理.Text == "system proxy")
			{
			...
			if (combox_代理.Text == "custom proxy")
			{
			...
			var value23 = IniHelp.GetValue("截图音效", "Clipboard");
			if (value23 == "发生错误")
			{
		...
		private void Baidu申请_Click(object sender, EventArgs e)
		{
		...
		private void tab_标签_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (tab_标签.SelectedTab == Page_Key)
			{
		...
		{
			text_baiduaccount.Text = "PB8wYwNlVzUtstrLGcSwNcxB";
			text_baidupassword.Text = "beVd5FKLSQ4hBKCaE5PyNzhGfNaKR1cn";
		}
		...
		private void txtBox_KeyUp(object sender, KeyEventArgs e)
		{
			...
			{
				textBox.Text = "Please press the shortcut key";
		...
		private void Baidu_btn_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show("Key正确!", "提醒");
				return;
			}
			MessageBox.Show("请确保Key正确!", "提醒");
		}
		...
		private void Form1_FormClosed(object sender, FormClosedEventArgs e)
		{
			...
			IniHelp.SetValue("快捷键", "记录界面", txtBox_记录界面.Text);
			IniHelp.SetValue("快捷键", "识别界面", txtBox_识别界面.Text);
			IniHelp.SetValue("Key_Baidu", "secret_id", text_baiduaccount.Text);
			IniHelp.SetValue("Key_Baidu", "secret_key", text_baidupassword.Text);
			...
			IniHelp.SetValue("截图音效", "Clipboard", chbox_copy.Checked.ToString());
			if (!chbox_取色.Checked)
			{
		...
		public static void AutoStart(bool isAuto)
		{
			...
			{
				MessageBox.Show("You need administrator privileges to modify", "Tip");
			}
		}
