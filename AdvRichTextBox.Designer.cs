...
namespace TrOCR
{
    ...
    public class AdvRichTextBox : UserControl
    {
        ...
        public void InitializeComponent()
        {
            ...
            this.mode_Top = new ToolStripMenuItem();
            ...
            this.toolStripButtonBold.Text = "Bold font";
            ...
            this.toolStripButtonParagraph.Text = "Automatically segment by location\r\nOnly support Sogou interface";
            ...
            this.toolStripButtonFind.Text = "Find\\Replace";
            ...
            this.toolStripButtonMerge.Text = "Combine text into one paragraph";
            ...
            this.toolStripButtonVoice.Text = "Read";
            ...
            this.toolStripButtonFull.Text = "Align both ends";
            ...
            this.toolStripButtonspace.Text = "Indent first line";
            ...
            this.toolStripButtonFence.Text = "Automatically split into columns when taking screenshots\r\nInvalid for multiple selections\r\nClick to display the column diagram";
            ...
            this.toolStripButtonSend.Text = "Copy/Send";
            ...
            this.toolStripButtonSplit.Text = "Split by lines in the picture";
            ...
            this.toolStripButtoncheck.Text = "Check text for typos";
            ...
            this.toolStripButtonTrans.Text = "Translate";
            ...
            this.toolStripButtonNote.Text = "Record Form";
        ...
        public void topmost_keydown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                IniHelp.SetValue("工具栏", "Top", "False");
                HelpWin32.SendMessage(StaticValue.mainhandle, 600, 725);
            }
        }
        ...
        {
            string value = IniHelp.GetValue("工具栏", "Top");
            if (IniHelp.GetValue("工具栏", "Top") == "发生错误")
            {
                IniHelp.SetValue("工具栏", "Top", "False");
            }
            try
        ...
        {
            IniHelp.SetValue("工具栏", "Top", this.topmost_flag.ToString());
        }
        ...
        private ToolStripMenuItem mode_Top;
