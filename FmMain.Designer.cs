namespace TrOCR
{
	...
	public partial class FmMain : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.minico.BalloonTipText = "Minimize to taskbar";
			this.minico.BalloonTipTitle = "Tip";
			this.minico.Icon = (global::System.Drawing.Icon)componentResourceManager.GetObject("minico.Icon");
			this.minico.Text = "Double click to start screenshot recognition";
			...
			if (global::TrOCR.IniHelp.GetValue("配置", "Interface") == "Baidu")
			{
				this.ch_en.Text = "CH_EN√";
			}
			else
			{
				this.ch_en.Text = "CH_EN";
			...
			base.Name = "Form1";
			this.Text = "Time cost：";
			if (global::TrOCR.IniHelp.GetValue("工具栏", "Top") == "True")
			{
				base.TopMost = true;
			}
			else
